...
public interface Network {
     ...
     * {@link net.minecraft.world.level.block.entity.BlockEntity#invalidate()}) or unloaded
     * (e.g. in {@link net.minecraft.world.level.block.entity.BlockEntity#onChunkUnload()}).
